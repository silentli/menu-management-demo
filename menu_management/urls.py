...
urlpatterns = [
    ...
    path(
        'staff/dashboard/',
        staff_views.StaffDashboardView.as_view(),
        name='staff_dashboard',
    ),
    path('staff/menu/', staff_views.StaffMenuListView.as_view(), name='staff_menu_list'),
    path(
        'staff/menu/create/',
        staff_views.StaffMenuCreateView.as_view(),
        name='staff_menu_create',
    ),
    path(
    ...
    path(
        'staff/inventory/',
        staff_views.InventoryListView.as_view(),
        name='inventory_list',
    ),
    path(
        'staff/inventory/low-stock/',
        staff_views.LowStockListView.as_view(),
        name='low_stock_list',
    ),
    path(
    ...
    path(
        'staff/orders/',
        staff_views.StaffOrderListView.as_view(),
